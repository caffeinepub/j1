...
export class Backend implements backendInterface {
    ...
    async addResult(arg0: Result): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addResult(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateResult(arg0: Result): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateResult(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
